...
class ContractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract" do
    assert_difference('Contract.count') do
      post contracts_url, params: { contract: { book_id: @contract.book_id, name: @contract.name, sections: @contract.sections } }
    end
  ...
  test "should update contract" do
    patch contract_url(@contract), params: { contract: { book_id: @contract.book_id, name: @contract.name, sections: @contract.sections } }
