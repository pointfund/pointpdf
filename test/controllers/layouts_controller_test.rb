...
class LayoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create layout" do
    assert_difference('Layout.count') do
      post layouts_url, params: { layout: { name: @layout.name, page_part_id: @layout.page_part_id, posx: @layout.posx, posy: @layout.posy } }
    end
  ...
  test "should update layout" do
    patch layout_url(@layout), params: { layout: { name: @layout.name, page_part_id: @layout.page_part_id, posx: @layout.posx, posy: @layout.posy } }
